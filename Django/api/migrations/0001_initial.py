    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('questions', models.ManyToManyField(related_name='question_set', to='api.Question')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chose_options', models.ManyToManyField(to='api.Option')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api.question')),
                ('test_record', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='answer_set', to='api.testrecord')),
            ],
            options={
