...
class UserDetail(BaseModel):
    ...
    icon = models.ImageField(default='test')
    describe = models.CharField(max_length=256, blank=True)
...
class TestRecord(BaseModel):
    ...
    def __str__(self):
        return str(self.create_time) + " | " + self.user.name
        # 多表连接
...
class AnswerRecord(BaseModel):
    ...
    def __str__(self):
        return self.test_record.test_name + "|" + self.test_record.user.name + "| uid:" + str(self.test_record.user.id)
